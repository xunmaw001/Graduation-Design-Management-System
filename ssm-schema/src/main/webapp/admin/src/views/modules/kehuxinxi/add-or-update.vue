      ...
      <el-row>
        ...
        <el-form-item  v-if="type!='info'"  label="客户号" prop="kehuhao">
          <el-input v-model="ruleForm.kehuhao" 
              placeholder="客户号" clearable></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item v-if="ruleForm.dizhi" label="地址" prop="dizhi">
              <el-input v-model="ruleForm.dizhi" 
                placeholder="地址" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="传真" prop="chuanzhen">
          <el-input v-model="ruleForm.chuanzhen" 
              placeholder="传真" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.chuanzhen" label="传真" prop="chuanzhen">
              <el-input v-model="ruleForm.chuanzhen" 
          ...
          <el-form-item v-if="ruleForm.lianxidianhua" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="联系人邮箱" prop="lianxirenyouxiang">
          <el-input v-model="ruleForm.lianxirenyouxiang" 
              placeholder="联系人邮箱" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.lianxirenyouxiang" label="联系人邮箱" prop="lianxirenyouxiang">
              <el-input v-model="ruleForm.lianxirenyouxiang" 
                placeholder="联系人邮箱" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='lianxirenyouxiang'){
            this.ruleForm.lianxirenyouxiang = obj[o];
            continue;
          }
                    if(o=='beizhu'){
