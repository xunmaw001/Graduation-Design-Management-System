          ...
          <el-form-item v-if="ruleForm.biaoti" label="标题" prop="biaoti">
              <el-input v-model="ruleForm.biaoti" 
                placeholder="标题" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="活动时间" prop="huodongshijian">
          <el-input v-model="ruleForm.huodongshijian" 
              placeholder="活动时间" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.huodongshijian" label="活动时间" prop="huodongshijian">
              <el-input v-model="ruleForm.huodongshijian" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zuzhihuodong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zuzhihuodongCrossAddOrUpdateFlag = false;
                  this.parent.search();
                }
              });
            } else {
