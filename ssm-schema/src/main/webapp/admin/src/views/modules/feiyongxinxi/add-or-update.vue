          ...
          <el-form-item v-if="ruleForm.yonghuming" label="用户名" prop="yonghuming">
              <el-input v-model="ruleForm.yonghuming" 
                placeholder="用户名" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="处方费用" prop="chufangfeiyong">
          <el-input v-model="ruleForm.chufangfeiyong" 
              placeholder="处方费用" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.chufangfeiyong" label="处方费用" prop="chufangfeiyong">
              <el-input v-model="ruleForm.chufangfeiyong" 
                placeholder="处方费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                          <el-col :span="12">
          ...
          <el-form-item v-if="ruleForm.dengjishijian" label="登记时间" prop="dengjishijian">
              <el-input v-model="ruleForm.dengjishijian" 
                placeholder="登记时间" readonly></el-input>
                                                                                                                                                            ...
                                                                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="处方详情" prop="chufangxiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.chufangxiangqing" label="处方详情" prop="chufangxiangqing">
                    <span v-html="ruleForm.chufangxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
