<template>
  <div>
    ...
    >
      <el-row>
                  <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="管理员工号" prop="guanliyuangonghao">
          <el-input v-model="ruleForm.guanliyuangonghao" 
              placeholder="管理员工号" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.guanliyuangonghao" label="管理员工号" prop="guanliyuangonghao">
              <el-input v-model="ruleForm.guanliyuangonghao" 
          ...
          <el-form-item v-if="ruleForm.xuexiao" label="学校" prop="xuexiao">
              <el-input v-model="ruleForm.xuexiao" 
                placeholder="学校" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="职务" prop="zhiwu">
          <el-input v-model="ruleForm.zhiwu" 
              placeholder="职务" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.zhiwu" label="职务" prop="zhiwu">
              <el-input v-model="ruleForm.zhiwu" 
...
export default {
  ...
  methods: {
        ...
        for (var o in obj){
            ...
            continue;
                                                                                ...
                                                                                // 多级联动参数
                                                                                                      info(id) {
      this.$http({
        url: `tushuguanguanliyuan/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tushuguanguanliyuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tushuguanguanliyuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
                }
              });
            } else {
