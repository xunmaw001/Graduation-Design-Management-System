...
public class XueshengtiwenController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,XueshengtiwenEntity xueshengtiwen, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("xuesheng")) {
			xueshengtiwen.setXueshengxuehao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XueshengtiwenEntity xueshengtiwen, HttpServletRequest request){
        EntityWrapper<XueshengtiwenEntity> ew = new EntityWrapper<XueshengtiwenEntity>();
		PageUtils page = xueshengtiwenService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xueshengtiwen), params), params));
        return R.ok().put("data", page);
    }
