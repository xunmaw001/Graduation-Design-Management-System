        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                        ...
                        <el-col :span="12">
        <el-form-item v-if="type!='info'" label="置换时间" prop="zhihuanshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.zhihuanshijian" 
                type="datetime"
                placeholder="置换时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.zhihuanshijian" label="置换时间" prop="zhihuanshijian">
              <el-input v-model="ruleForm.zhihuanshijian" 
                placeholder="置换时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                        </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='zhihuanshijian'){
            this.ruleForm.zhihuanshijian = obj[o];
            continue;
          }
                  }
                                                                                                                                              }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                              ...
                                                                              this.xinjiuchengduOptions = "九成新,八成新,五成新,二成新".split(',')
                                        this.$http({
              url: `option/fenleixinxi/fenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zhihuanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhihuanxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
                }
              });
            } else {
