  ...
  <div>
    ...
    >
      <el-row>
          ...
          <el-form-item v-if="ruleForm.jiaoshixingming" label="教师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item v-if="type!='info'" label="提问时间" prop="tiwenshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tiwenshijian" label="提问时间" prop="tiwenshijian">
              <el-input v-model="ruleForm.tiwenshijian" 
                placeholder="提问时间" readonly></el-input>
                                                                                                                  ...
                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="我要提问" prop="woyaotiwen">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.woyaotiwen" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.woyaotiwen" label="我要提问" prop="woyaotiwen">
                    <span v-html="ruleForm.woyaotiwen"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
                    if(o=='woyaotiwen'){
            this.ruleForm.woyaotiwen = obj[o];
            continue;
          }
                    if(o=='xueshengxuehao'){
