          ...
          <el-form-item v-if="ruleForm.tijiaoshijian" label="提交时间" prop="tijiaoshijian">
              <el-input v-model="ruleForm.tijiaoshijian" 
                placeholder="提交时间" readonly></el-input>
                                                                                                                                                            ...
                                                                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="开题报告" prop="kaitibaogao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.kaitibaogao" label="开题报告" prop="kaitibaogao">
                    <span v-html="ruleForm.kaitibaogao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
