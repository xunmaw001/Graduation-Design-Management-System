          ...
          <el-form-item v-if="ruleForm.xiangmumingcheng" label="项目名称" prop="xiangmumingcheng">
              <el-input v-model="ruleForm.xiangmumingcheng" 
                placeholder="项目名称" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="适合人群" prop="shiherenqun">
          <el-input v-model="ruleForm.shiherenqun" 
              placeholder="适合人群" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.shiherenqun" label="适合人群" prop="shiherenqun">
              <el-input v-model="ruleForm.shiherenqun" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `jianchaxiangmu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jianchaxiangmuCrossAddOrUpdateFlag = false;
                  this.parent.search();
                }
              });
            } else {
