          ...
          <el-form-item v-if="ruleForm.tijiaoshijian" label="提交时间" prop="tijiaoshijian">
              <el-input v-model="ruleForm.tijiaoshijian" 
                placeholder="提交时间" readonly></el-input>
                                                                                                                                                            ...
                                                                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="论文进度" prop="lunwenjindu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.lunwenjindu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.lunwenjindu" label="论文进度" prop="lunwenjindu">
                    <span v-html="ruleForm.lunwenjindu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='lunwenjindu'){
            this.ruleForm.lunwenjindu = obj[o];
            continue;
          }
                    if(o=='xueshengxuehao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `lunwenjindu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lunwenjinduCrossAddOrUpdateFlag = false;
                  this.parent.search();
                }
              });
            } else {
