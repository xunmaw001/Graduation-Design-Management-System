          ...
          <el-form-item v-if="ruleForm.xiaoshouyuangonghao" label="销售员工号" prop="xiaoshouyuangonghao">
              <el-input v-model="ruleForm.xiaoshouyuangonghao" 
                placeholder="销售员工号" readonly></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="销售员姓名" prop="xiaoshouyuanxingming">
          <el-input v-model="ruleForm.xiaoshouyuanxingming" 
              placeholder="销售员姓名" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.xiaoshouyuanxingming" label="销售员姓名" prop="xiaoshouyuanxingming">
              <el-input v-model="ruleForm.xiaoshouyuanxingming" 
                placeholder="销售员姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                        <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='xiaoshouyuanxingming'){
            this.ruleForm.xiaoshouyuanxingming = obj[o];
            continue;
          }
                    if(o=='mima'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xiaoshouyuanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xiaoshouyuanxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
                }
              });
            } else {
