  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
                ...
                <el-input v-model="searchForm.qichepinpai" 
                    placeholder="汽车品牌" clearable></el-input>
              </el-form-item>
                                                                  <el-form-item label="汽车型号">
                <el-input v-model="searchForm.qichexinghao" 
                ...
                <el-input v-model="searchForm.haoyouliang" 
      ...
      let params = {
        ...
        sort: 'id',
            ...
            params['zuowei'] = '%' + this.searchForm.zuowei + '%'
                                                            ...
                                                            if(this.searchForm.haoyouliang!='' && this.searchForm.haoyouliang!=undefined){
            params['haoyouliang'] = '%' + this.searchForm.haoyouliang + '%'
          }
                                                                          this.$http({
        url: "qichexinxi/page",
        method: "get",
