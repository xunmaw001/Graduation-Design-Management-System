  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
                ...
                <el-input v-model="searchForm.xiangmu" 
                    placeholder="项目" clearable></el-input>
                                                                                                                        ...
                                                                                                                        <el-form-item label="农户账号">
                <el-input v-model="searchForm.nonghuzhanghao" 
                    placeholder="农户账号" clearable></el-input>
              </el-form-item>
                                                                                                                                                  <el-form-item>
          <el-button round @click="search()">查询</el-button>
          <el-button
            v-if="isAuth('zhongzhichangdi','新增')"
            type="primary"
            @click="addOrUpdateHandler()"
            round
          >新增</el-button>
          <el-button
            v-if="isAuth('zhongzhichangdi','删除')"
      ...
      <div class="table-content">
        <el-table
            v-if="isAuth('zhongzhichangdi','查看')"
            :data="dataList"
            border
            ...
            <el-table-column
                ...
                label="操作">
                <template slot-scope="scope">
                                <el-button v-if="isAuth('zhongzhichangdi','查看')" type="text" icon="el-icon-edit" size="small" @click="addOrUpdateHandler(scope.row.id,'info')">详情</el-button>
                                                                <el-button v-if="isAuth('zhongzhichangdi','预约')" type="text" icon="el-icon-edit" size="small" @click="yuyuexinxiCrossAddOrUpdateHandler(scope.row,'cross')">预约</el-button>
                                                <el-button v-if="isAuth('zhongzhichangdi','留言')" type="text" icon="el-icon-edit" size="small" @click="liuyanxinxiCrossAddOrUpdateHandler(scope.row,'cross')">留言</el-button>
                                                                <el-button v-if="isAuth('zhongzhichangdi','修改')" type="text" icon="el-icon-edit" size="small" @click="addOrUpdateHandler(scope.row.id)">修改</el-button>
                <el-button v-if="isAuth('zhongzhichangdi','删除')" type="text" icon="el-icon-delete" size="small" @click="deleteHandler(scope.row.id)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
                                                                                                                                                                                                                <el-pagination
...
export default {
  ...
  methods: {
      ...
      this.$storage.set('crossTable','zhongzhichangdi');
      this.$nextTick(() => {
