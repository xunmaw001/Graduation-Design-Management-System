<template>
  <div>
    ...
    <el-form :model="rulesForm" :rules="rules" ref="rulesForm" class="login-form">
      ...
      <el-form-item label="">
                        <a style="margin-right:10px" href="javascript:void(0)" @click="register('xuesheng')">注册学生</a>
                                <a style="margin-right:10px" href="javascript:void(0)" @click="register('jiaoshi')">注册教师</a>
                                                                                                                                                                                                                                      </el-form-item>
