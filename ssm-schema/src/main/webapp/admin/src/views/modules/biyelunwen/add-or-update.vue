          ...
          <el-form-item v-if="ruleForm.tijiaoshijian" label="提交时间" prop="tijiaoshijian">
              <el-input v-model="ruleForm.tijiaoshijian" 
                placeholder="提交时间" readonly></el-input>
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="毕业论文" prop="biyelunwen">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.biyelunwen" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.biyelunwen" label="毕业论文" prop="biyelunwen">
                    <span v-html="ruleForm.biyelunwen"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
            ...
            continue;
                    ...
                    if(o=='biyelunwen'){
            this.ruleForm.biyelunwen = obj[o];
            continue;
          }
                    if(o=='xueshengxuehao'){
