<template>
  <div>
    ...
    >
      <el-row>
                  <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="仓管员账号" prop="cangguanyuanzhanghao">
          <el-input v-model="ruleForm.cangguanyuanzhanghao" 
              placeholder="仓管员账号" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.cangguanyuanzhanghao" label="仓管员账号" prop="cangguanyuanzhanghao">
              <el-input v-model="ruleForm.cangguanyuanzhanghao" 
                placeholder="仓管员账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                        <el-col :span="12">
        <el-form-item  v-if="type!='info'"  label="仓管员姓名" prop="cangguanyuanxingming">
          <el-input v-model="ruleForm.cangguanyuanxingming" 
              placeholder="仓管员姓名" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.cangguanyuanxingming" label="仓管员姓名" prop="cangguanyuanxingming">
              <el-input v-model="ruleForm.cangguanyuanxingming" 
                placeholder="仓管员姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                        <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
                    if(o=='cangguanyuanzhanghao'){
            this.ruleForm.cangguanyuanzhanghao = obj[o];
            continue;
          }
                    if(o=='cangguanyuanxingming'){
            this.ruleForm.cangguanyuanxingming = obj[o];
            continue;
          }
                    if(o=='mima'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `cangguanyuanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.cangguanyuanxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
                }
              });
            } else {
